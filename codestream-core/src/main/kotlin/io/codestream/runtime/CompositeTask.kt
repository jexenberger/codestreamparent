...
class CompositeTask(
    ...
    override fun preTraversal(ctx: io.codestream.runtime.StreamContext) = BranchProcessingDirective.continueExecution

    override fun postTraversal(ctx: io.codestream.runtime.StreamContext) = BranchProcessingDirective.done
